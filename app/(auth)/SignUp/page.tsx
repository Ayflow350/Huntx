    ...
    <div className="flex flex-col  px-4  lg:flex-row justify-between">
      ...
      <div className="h-[70vh] lg:h-screen  flex-1  text-center lg:mr-10 px-4 justify-center flex   ">
        <div className="mt-10 flex flex-col text-center space-y-8">
          ...
          <button className="border-[#CCCCF5] mx-auto flex flex-row gap-x-2  border-2 px-[100px] py-[8px] lg:py-[12px] lg:px-[108px]  font-epilogue text-[#4640DE] justify-center items-center font-bold text-[16px] ">
            <span>
              <Image
                src={GoggleLogo}
                alt="GoggleLogo"
          ...
          <div className=" space-y-[22px] px-4">
            <div className="text-left">
              <h1 className="text-[#515B6F] font-semibold mb-2">Full Name</h1>
              <input
                type="text"
            ...
            <h1 className="text-[#202430] text-base">
              Already have an account?{" "}
              <span className="text-[#4640DE] font-semibold">Login</span>
            </h1>
          </div>
          <div className="">
            <p className="w-[400px] text-[#7C8493] text-left text-[14px]">
